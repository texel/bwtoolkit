...
- (void)drawBezelWithFrame:(NSRect)cellFrame inView:(NSView *)controlView
{
	...
	[bottomBorderColor bwDrawPixelThickLineAtPosition:-1 withInset:0 inRect:cellFrame inView:[self controlView] horizontal:YES flip:YES];
	...
	if (inBorderedBar)
	{
		[borderedTopBorderColor bwDrawPixelThickLineAtPosition:1 withInset:0 inRect:cellFrame inView:[self controlView] horizontal:YES flip:NO];
